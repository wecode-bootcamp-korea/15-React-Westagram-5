                    ...
                    <div className="mainBar">
                        <div className="barOutline">
                            <div className="logoOutline">
                                <img src="./images/mbg/735145cfe0a4.png" className="logo" alt="로고 이미지"/>
                            </div>
                            ...
                            <div className="iconsOutline">
                                <div className="icons">
                                    <img src="./images/mbg/home.png" className="homeIcon" alt="홈아이콘"/>
                                    <img src="./images/mbg/airplane.png" className="messageIcon" alt="메시지아이콘"/>
                                    <img src="./images/mbg/compass.png" className="exploreIcon" alt="콤파스아이콘"/>
                                    <img src="./images/mbg/heart.png" className="activityIcon" alt="하트아이콘"/>
                                    <img src="./images/mbg/IMG_20201112_204911_512.jpg" className="profileIcon" alt="아이콘프로필"/>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="storyBar">
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/120948293_779766016147236_976515620587209369_n.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>jacob.lee19</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="/images/mbg/126245932_1164257410643962_5670031182066747216_n.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>moone_hyeon</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/winter.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>writer_winter</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/cine21.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>cine_21</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/hosico.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>hosico_cat</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/unknown.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>unknown</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/aram.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>aglioolive0206</p>
                                        </div>
                                    </span>
                                    <span className="storyContents">
                                        <div className="storyOutline">
                                            <img src="./images/mbg/iz.jpg" className="storyProfile" alt="스토리 유저"/>
                                            <p>official_izone</p>
                                        </div>
                                    </span>
                                </div>
                            <div className="feedContents">
                                <div className="profileHeader">
                                    <div className="feedUploader">
                                        <img src="/images/mbg/hosico.jpg" className="uploaderPhoto" alt="피드 업로더"/>
                                        <div className="uploaderOutline">
                                            <p>hosico_cat</p>
                                            <button type="button"><img src="./images/mbg/more.png" className="moreInfo" alt="더보기아이콘"/></button>
                                        </div>
                                    </div>
                                    <img src="./images/mbg/hosico_cat_20201113_1.png" className="feedPhoto" alt="피드 사진"/>
                                    <div className="reactionContents">
                                        <div className="reactionBar">
                                            <div className="reactionIcons">
                                                <img src="./images/mbg/heart.png" className="activityIcon" alt="하트 아이콘"/>
                                                <img src="./images/mbg/chat-bubble.png" className="replyIcon" alt="댓글 아이콘"/>
                                                <img src="./images/mbg/airplane.png" className="messageIcon" alt="메시지 아이콘"/>
                                            </div>
                                            <img src="./images/mbg/free-icon-tag-1415025.png" className="bookmarkIcon" alt="북마크 아이콘"/>
                                        </div>
                                              ...
                                              <ul>
                                                  <li>
                                                   ...
                                                   <div className="comment">
                                                    ...
                                                    return <li key={idx}> 
                                                    <a href="https://www.instagram.com/" className="userId">moonvenn_dev  </a>
                                                    {comm}</li>
                                                    })}
                                                  </li>
                                              </ul>
                        ...
                        <div className="sideBar">
                            <div className="Bio">
                                <div className="profile">
                                    <img src="./images/mbg/IMG_20201112_204911_512.jpg" className="profilePhoto" alt="profile"/>
                                ...
                                <div className="recommendProfile">
                                    ...
                                    <div className="recommendUserList">
                                        <div className="recommendUser">
                                            <img src="./images/mbg/u1.jpg" className="recommendUserPhoto" alt="user"/>
                                            <div>
                                        ...
                                        <div className="recommendUser">
                                            <img src="./images/mbg/u2.jpg" className="recommendUserPhoto" alt="user"/>
                                            <div>
                                        ...
                                        <div className="recommendUser u3">
                                            <img src="./images/mbg/u3.jpg" className="recommendUserPhoto" alt="user"/>
                                            <div>
                                        ...
                                        <div className="recommendUser">
                                            <img src="./images/mbg/u4.jpg" className="recommendUserPhoto" alt="user"/>
                                            <div>
                                        ...
                                        <div className="recommendUser">
                                            <img src="./images/mbg/u5.jpg" className="recommendUserPhoto" alt="user"/>
                                            <div>
